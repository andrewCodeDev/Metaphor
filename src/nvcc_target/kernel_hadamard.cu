...
extern "C" void launch_hadamard_r16(
  ...
  __kernel_hadamard_r16<<<1, GRID_1D(N), 32, getStream(stream)>>>(a, b, c, N);
}
...
extern "C" void launch_hadamard_c16(
  ...
  __kernel_hadamard_c16<<<1, GRID_1D(N), 32, getStream(stream)>>>(a, b, c, N);
}
...
extern "C" void launch_hadamard_r32(
  ...
  __kernel_hadamard_r32<<<1, GRID_1D(N), 32, getStream(stream)>>>(a, b, c, N);
}
...
extern "C" void launch_hadamard_c32(
  ...
  __kernel_hadamard_c32<<<1, GRID_1D(N), 32, getStream(stream)>>>(a, b, c, N);
}
...
extern "C" void launch_hadamard_r64(
  ...
  __kernel_hadamard_r64<<<1, GRID_1D(N), 32, getStream(stream)>>>(a, b, c, N);
}
...
extern "C" void launch_hadamard_c64(
  ...
  __kernel_hadamard_c64<<<1, GRID_1D(N), 32, getStream(stream)>>>(a, b, c, N);
}
