...
pub extern fn launch_addition_r16(stream: StreamCtx, a: ?*const anyopaque, b: ?*const anyopaque, c: ?*anyopaque, N: len_t) void;
pub extern fn launch_addition_r32(stream: StreamCtx, a: ?*const anyopaque, b: ?*const anyopaque, c: ?*anyopaque, N: len_t) void;
pub extern fn launch_addition_r64(stream: StreamCtx, a: ?*const anyopaque, b: ?*const anyopaque, c: ?*anyopaque, N: len_t) void;
pub extern fn launch_subtraction_r16(stream: StreamCtx, a: ?*const anyopaque, b: ?*const anyopaque, c: ?*anyopaque, N: len_t) void;
pub extern fn launch_subtraction_r32(stream: StreamCtx, a: ?*const anyopaque, b: ?*const anyopaque, c: ?*anyopaque, N: len_t) void;
pub extern fn launch_subtraction_r64(stream: StreamCtx, a: ?*const anyopaque, b: ?*const anyopaque, c: ?*anyopaque, N: len_t) void;
