...
extern "C" void launch_subtraction_reverse_r16(
  ...
  __kernel_subtraction_reverse_r16<<<1, GRID_1D(N), 32, getStream(stream)>>>(a, b, coef, N);
}
...
extern "C" void launch_subtraction_reverse_c16(
  ...
  __kernel_subtraction_reverse_c16<<<1, GRID_1D(N), 32, getStream(stream)>>>(a, b, coef, N);
...
extern "C" void launch_subtraction_reverse_r32(
  ...
  __kernel_subtraction_reverse_r32<<<1, GRID_1D(N), 32, getStream(stream)>>>(a, b, coef, N);
}
...
extern "C" void launch_subtraction_reverse_c32(
  ...
  __kernel_subtraction_reverse_c32<<<1, GRID_1D(N), 32, getStream(stream)>>>(a, b, coef, N);
  CUDA_ASSERT(cudaDeviceSynchronize());
}
...
extern "C" void launch_subtraction_reverse_r64(
  ...
  __kernel_subtraction_reverse_r64<<<1, GRID_1D(N), 32, getStream(stream)>>>(a, b, coef, N);
}
...
extern "C" void launch_subtraction_reverse_c64(
  ...
  __kernel_subtraction_reverse_c64<<<1, GRID_1D(N), 32, getStream(stream)>>>(a, b, coef, N);
  CUDA_ASSERT(cudaDeviceSynchronize());
}
